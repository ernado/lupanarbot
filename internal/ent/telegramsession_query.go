...
func (tsq *TelegramSessionQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (tsq *TelegramSessionQuery) FirstIDX(ctx context.Context) int {
...
func (tsq *TelegramSessionQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (tsq *TelegramSessionQuery) OnlyIDX(ctx context.Context) int {
...
func (tsq *TelegramSessionQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (tsq *TelegramSessionQuery) IDsX(ctx context.Context) []int {
	ids, err := tsq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (tsq *TelegramSessionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(telegramsession.Table, telegramsession.Columns, sqlgraph.NewFieldSpec(telegramsession.FieldID, field.TypeInt))
	_spec.From = tsq.sql
