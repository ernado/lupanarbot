...
func (_q *TelegramChannelQuery) All(ctx context.Context) ([]*TelegramChannel, error) {
	...
	return withInterceptors[[]*TelegramChannel](ctx, _q, qr, _q.inters)
}
...
func (_q *TelegramChannelQuery) IDs(ctx context.Context) (ids []int64, err error) {
	...
	if err = _q.Select(telegramchannel.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *TelegramChannelQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*TelegramChannelQuery](), _q.inters)
}
...
func (_q *TelegramChannelQuery) Clone() *TelegramChannelQuery {
	...
	return &TelegramChannelQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]telegramchannel.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.TelegramChannel{}, _q.predicates...),
...
func (_q *TelegramChannelQuery) GroupBy(field string, fields ...string) *TelegramChannelGroupBy {
	...
	grbuild := &TelegramChannelGroupBy{build: _q}
...
func (_q *TelegramChannelQuery) Select(fields ...string) *TelegramChannelSelect {
	...
	sbuild := &TelegramChannelSelect{TelegramChannelQuery: _q}
...
func (_q *TelegramChannelQuery) prepareQuery(ctx context.Context) error {
...
func (_q *TelegramChannelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*TelegramChannel, error) {
	var (
	...
	_spec.Assign = func(columns []string, values []any) error {
		node := &TelegramChannel{config: _q.config}
...
func (_q *TelegramChannelQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *TelegramChannelQuery) querySpec() *sqlgraph.QuerySpec {
...
func (_q *TelegramChannelQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *TelegramChannelGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TelegramChannelQuery, *TelegramChannelGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *TelegramChannelGroupBy) sqlScan(ctx context.Context, root *TelegramChannelQuery, v any) error {
...
func (_s *TelegramChannelSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*TelegramChannelQuery, *TelegramChannelSelect](ctx, _s.TelegramChannelQuery, _s, _s.inters, v)
}

func (_s *TelegramChannelSelect) sqlScan(ctx context.Context, root *TelegramChannelQuery, v any) error {
