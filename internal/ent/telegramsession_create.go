...
func (tsc *TelegramSessionCreate) SetID(i int) *TelegramSessionCreate {
...
func (tsc *TelegramSessionCreate) createSpec() (*TelegramSession, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(telegramsession.Table, sqlgraph.NewFieldSpec(telegramsession.FieldID, field.TypeInt))
	)
